...
class ValItemContext;
class ValArItemContext;
...
class KeyItemContext : public Builder{
  public:
    ...
    ValItemContext Value(Node::Value val);
...
class ValItemContext : public Builder{
  public:
    ValItemContext(Builder& bild);
  ...
  private:
    using Builder::EndArray, Builder::StartArray, Builder::StartDict, Builder::Value, Builder::Build;
    Builder& builder_;
};
...
class ArrayItemContext : public Builder{
  public:
    ...
    ValArItemContext Value(Node::Value val);
    DictItemContext StartDict();
    ArrayItemContext StartArray();
    Builder& EndArray();
...
class ValArItemContext : public Builder{
public:
    ValArItemContext(Builder& bild);
